...
<div id="wedding_info_section">
    <p class="back_link"><a href="<?php echo 'index.php?ssbw/memberDetails/'.$userId ?>">&#60;&#60; Back to Details</a></p>
    ...
    <form id="edit_wedding_form" action="<?php echo 'index.php?ssbw/updateMemberWedding/'.$userId; ?>" method="post">
